...
namespace App\Livewire\Core\Setting\Finance;
...
class Index extends Component
{
    ...
    {
        $this->name = SettingFinance::NAME;

        // Init
        foreach (SettingFinance::ALL as $key => $value) {
    ...
    {
        $this->redirectRoute('setting_finance.index');
    }
    ...
    {
        return view('livewire.core.setting.finance.index');
    }
}
