...
@section('header')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <!--begin::Title-->
        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Transaksi - Detail</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
...
@section('content')
    <div class="card">
        <div class="card-body">
            <livewire:transaction.transaction.detail :objId="$objId">
        </div>
    </div>
@stop
