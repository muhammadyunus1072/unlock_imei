...
<head>
    ...
    <style>
        ...
        [data-kt-app-layout=dark-sidebar] .app-sidebar .menu>.menu-item.here>.menu-sub.active .menu-title {
            color: #fff;
        }
        [data-kt-app-layout=dark-sidebar] .app-sidebar .menu>.menu-item.here>.menu-sub.active .menu-icon{
            color: #fff;
        }
        [data-kt-app-layout=dark-sidebar] .app-sidebar .menu>.menu-item.here>.menu-sub.active .menu-arrow{
            color: #fff;
        }
